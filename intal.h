...
char* intal_add(const char* intal1, const char* intal2);        //done

// Returns the comparison value of two intals.
// Returns 0 when both are equal.
// Returns +1 when intal1 is greater, and -1 when intal2 is greater.
int intal_compare(const char* intal1, const char* intal2);  //done

// Returns the difference (obviously, nonnegative) of two intals.
char* intal_diff(const char* intal1, const char* intal2);   //done

// Returns the product of two intals.
char* intal_multiply(const char* intal1, const char* intal2);       //done
...
char* intal_mod(const char* intal1, const char* intal2);    //done
...
char* intal_pow(const char* intal1, unsigned int n);        //done
...
char* intal_gcd(const char* intal1, const char* intal2);        //done

// Returns nth fibonacci number.
// intal_fibonacci(0) = intal "0".
// intal_fibonacci(1) = intal "1".
char* intal_fibonacci(unsigned int n);      //done

// Returns the factorial of n.
char* intal_factorial(unsigned int n);      //done
